...
import edu.ec.ups.dao.impl.binario.UsuarioDAOArchivoBinario;
import edu.ec.ups.dao.impl.texto.CarritoDAOArchivoTexto;
 ...
 * configurar el idioma, crear DAOs y controladores, e iniciar las vistas correspondientes según el rol del usuario.
 */
public class Main {
    /**
    ...
    /**
     * Carga productos por defecto al sistema si no existen.
     *
     * @param productoDAO instancia DAO donde se agregarán los productos.
     */
